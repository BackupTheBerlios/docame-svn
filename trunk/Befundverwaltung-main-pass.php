...
$allowedarea=&$allow_area['Befundverwaltung'];


//hier wird die Variable gesetzt falls man auf "Schliessen" klickt
$breakfile='sub_'.'Befundverwaltung.php?sid='.$sid.'&lang='.$lang;
$target="Befundverwaltung";
switch($target)
{
	
	case 'Befundverwaltung':	$title=$LDSystemLogin;
								//$userck='ck_edv_admin_user';
								$fileforward=$root_path."/modules/Befundverwaltung/Befundverwaltung.php?sid=$sid&lang=$lang&from=$from";
								break;
