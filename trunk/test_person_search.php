...
$local_user='ck_Befundverwaltung_user';
...
//						echo '<a href="test.php'.URL_APPEND.'&pid='.$zeile['pid'].'&mode=new">';
						//echo URL_APPEND.'&depnr='.$my_dep_nr.'&pid='.$zeile['pid'].'&pname='.$pname;
						echo '<a href="Befundverwaltung_NeuBefund.php'.URL_APPEND.'&depnr='.$my_dep_nr.'&pid='.$zeile['pid'].'&pname='.$pname.'">';
